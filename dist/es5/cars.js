...
$(function () {
    ...
    $('.cart-content').on('click', '.add', function (e) {
        ...
        //console.log(danjia);
        //console.log(val);
        console.log(e.target.parentNode.parentNode.parentNode.parentNode.querySelector('.danjia').innerHTML, e.target.parentNode.parentNode.parentNode.parentNode.querySelector('.num').value);
